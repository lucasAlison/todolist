package br.com.javaplayground.todolist.task;
...
import br.com.javaplayground.todolist.Utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id) {
        ...
        if (!task.getIdUser().equals(idUser))
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("O usuário não tem permissão para editar esta tarega");
